...
class LE_OneToMany: public LE_Group {
    friend class LE_GameState;

    public:

        /**
         * @brief Define an interaction between game Objects A and B
         *
         ...
         * */
        virtual void interactorUpdateHandler(void* mainObj, void* gameObj) = 0;
